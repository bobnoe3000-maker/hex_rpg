...
export const APP_BUILD = "2026-08-22t · EVERY dungeon is now a roaming 3-level descent (camera follows the party, two mini-bosses gate the way down, the ridge ends at the dungeon's boss) — not just the first two. Dungeons 3–10 are generated by skinning a validated geometry template with each dungeon's roster, band, boss and two new named mini-bosses, so all ten play like the Misty Wetlands. Offline progress (10% rate, capped 8h) with a Welcome Back card. Party bar fits three characters; roaming stall guard; the rally flag is a real 'gather here' order; active skills grow with EVERY point";
