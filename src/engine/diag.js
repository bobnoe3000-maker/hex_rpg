...
export const APP_BUILD = "2026-08-24a · Overworld — the World tab (replacing Party) opens the Atlas: a continent of biome regions (Rolling Downs, Thornwood, Saltmarket Quay, Mirefen, Frostcrag) joined by routes around the Hearthwatch hub. Travel to a region and you WALK it on the delve engine — the same tiles, the same framed party tiles, the same follow-camera + minimap, on a big open biome floor. Tap to move; reach a ◆ portal to drop into its dungeon (or a cave), or an edge gate to travel to a neighbour or back to town. Manage your party from the Tavern / a hero tile now. — Prior: PvP Arena — now you WATCH the fight. Choosing a rival drops you onto a real dungeon floor and runs a live auto-battle — your party (gold) vs the rival team (blue), hero vs hero, cast for cast — on the very same engine as a delve, with a You/Foe counter, a 1×/2× speed toggle and Forfeit. When one side falls, VICTORY/DEFEAT shows and the result screen opens with your ELO swing, Valor + silver rewards and streak/promotion. The arena is consequence-free (your roster is healed after). Plus the rank shield (Bronze→Champion), Scout-reroll of Hard/Even/Favoured rivals, Leaderboard, and View Team. Prior: skill ranks clearer/smoother; every dungeon a roaming descent; offline progress; party bar fits three; rally flag order";
