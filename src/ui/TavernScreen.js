  ...
  function render() {
    ...
    const row = (h, i) => {
      ...
      return `<div class="shop-row">
        ...
        <span class="price">💰 ${ctx.hireCost}</span>
    ...
    el.innerHTML = `<div class="tw-wrap">
      <div class="shop-top">
        ...
        <span class="tw-cur"><span>💰 ${silver}</span></span>
      </div>
      ...
      <button class="tw-btn" data-refresh style="justify-content:center" ${silver < ctx.refreshCost ? "disabled" : ""}>🔄 New faces · 💰 ${ctx.refreshCost}</button>
    </div>`;
